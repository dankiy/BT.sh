# adapted from Data Science on the Google Cloud Platform 
# by by Valliappa Lakshmanan 
...
cd $SAVEPATH
for YEAR in `seq -w 2013 2018`; do
...
echo "header is ..."
head $YEAR$MONTH.csv
echo "should be 27 fields, there are: "
head -2 $YEAR$MONTH.csv | tail -1 | sed 's/,/ /g' | wc -w
